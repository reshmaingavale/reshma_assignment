...
class SwiftMailerComponent extends Object
{
    ...
    function _getBodyText($view)
    {
        ...
        $body = $this->controller->render($this->viewPath . DS . $view . '_text', $this->layout . DS . $view . '_text');
        ob_end_clean();
    ...
    function _getBodyHTML($view)
    {
        ...
        $tmpOutput = $this->controller->output;
        $tmpRender = $this->controller->autoRender;
//pr($this->viewPath . DS . $view . '_html');die;
        // Render the HTML email body.
        ob_start();
        $this->controller->output = null;
        $body = $this->controller->render($this->viewPath . DS . $view . '_html', $this->layout . DS . $view . '_html');
        ob_end_clean();
    ...
    function send($view = 'default', $subject = '')
    {
        ...
        $transport->setUsername('reshma@weboniselab.com');
        $transport->setPassword('nicegirl');

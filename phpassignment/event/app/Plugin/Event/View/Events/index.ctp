<div class="events index">
    ...
    <table cellpadding="0" cellspacing="0">
        <tr>
            ...
            <th><?php echo $this->Paginator->sort('EventDesc');?></th>
        ...
        foreach ($events as $event): ?>
            <tr>
                ...
                <td><?php echo h($event['Event']['eventdesc']); ?>&nbsp;</td>
                <td class="actions">
                    ...
                    <?php
                            ...
                            $end_date=$event['Event']['end_date'];
                             if($curr_date>=$start_date && $curr_date>=$end_date){
                                 echo "<b>"."Event Completed"."</b>";
                             }elseif($curr_date>=$start_date){echo "<b>"."Event Started"."</b>";}
                             else{
